...
<header>
        ...
        <div class = "navigationbar">
            <div clas = "logo">
                <a href = "gamestore/homepage.php"><img src = "icons/logo.jpeg" alt = "logo" width= "40%"></a>
            </div>
            <div class = "pages">
...
?>
Welcome <?php echo $_SESSION["profile_name"]; ?>. Click here to <a href="logout.php" tite="Logout">Logout.
<?php
